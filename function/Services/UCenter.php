...
class UCenter
{
    ...
    /**
     * 根据UID获取 LemonUCentreUser
     */
    public function getUserByUID($UID)
    {
        if (isset($this->userListByUID[$UID])) {
            return $this->userListByUID[$UID];
        } else {
            $user = new User();
            $user->LoadInfoByUID($UID);
            $this->userListByUID[$UID] = $user;
            return $user;
        }
    }
    ...
    public function getUserList($select = null, $w = null, $order = null, $limit = null, $option = null)
    {
        ...
        foreach ($result as $item) {
            ...
            $this->userListByUID[$item->UID] = $item;
        }
