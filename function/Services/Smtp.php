...
class SMTP
{
    ...
    /* Main Function */
    public function sendmail($to, $from, $subject, $body, $mailtype, $cc, $bcc, $additional_headers, $fromUser, $replyToAddress)
    {
        ...
        $header .= "Date: " . date("r") . "\r\n";
        $header .= "X-Mailer:By ZBlogPHP - LemonUCentre (PHP/" . phpversion() . ")\r\n";
