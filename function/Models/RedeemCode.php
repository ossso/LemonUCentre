...
class RedeemCode extends Base
{
    public function __construct()
    {
        ...
        parent::__construct($lemon_uc->table['LemonUCentreRedeemCode'], $lemon_uc->tableInfo['LemonUCentreRedeemCode'], __CLASS__);
    ...
    public function __get($name)
    {
        ...
        switch ($name) {
            ...
            break;
            case 'Product':
                return $lemon_uc->getRedeemCodeProductByID($this->ProductID);;
            break;
            case 'CodeValue':
